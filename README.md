...
Поскольку есть обработка финансовых операций, то чрезвычайно критична доставка одного и только одного сообщения и без потерь,
то есть уровень доставки exactly once.
...
Коэффициент выберем $K = \frac{d + 1}{d}$, где d - количество ДЦ.
...
<!-- При расчёте стоимости поездки, на вход передается маршрут, а именно виртуальный граф. -->



| Сервис | Целевая пиковая нагрузка, RPS | Сеть, Гбит/с |
| - | - | - |
| Авторизация | K x 190 = 222 | K x (0,0048 + 0,0048) = 0,0096 |
| Пользователи | K x (192 + 2 x 152) = 577 | 540 Б * 577  = 0.0025 Гб/с  |
| Геокодирование | K x 170 = 198 | 200 Б * 198 = 0.0003 Гб/с  |
| Маршрутизация | K x 2 x 170 = 397 | 12 Б * 397 = 0.00004 Гб/с |
| Геолокация | K x (2 x 152 + 40636) = 47763 | 0.016 |
| Расчёт стоимости поездки | K x 2 x 170 = 397 | 25,3 КБ * 8 * 397 = 0.08 Гб/с |
| Управление поездками | K x 942 = 1100 | 483 * 8 * 1100 = 0.04 |
| Чаты | K x 38 = 44 | 240 Б * 8 * 44 = 0,00008 Гб/с |
| Рейтинг | K x (152 + 122) = 320 | 92 Б * 8 * 320 = 0,0002 Гб/с |
| Оплата | K x 152 = 177 | 177 * 8 * 72 Б = 0.0001 Гб/с |
| История поездок | K x 3 = 4 | 0,00002 |
| API-gateway | 41778 | 0.14884 |
| S3 | 577 фото + 170 gpx = 747 | 0.94224 |
| nginx | 42525 | 1.1 | 

Рассчитаем аппартные ресурсы на каждый сервис
| Сервис | RPS | Характер бизнес-логики | CPU, ядер | RAM, ГБ |
| - | - | - | - | - |
| Авторизация | 222 | лёгкая | 1 | 3 |
| Пользователи | 577 | средняя | 6 | 58 |
| Геокодирование | 198 | тяжёлая | 20 | 20 |
| Маршрутизация | 397 | тяжёлая | 40 | 40 |
| Геолокация | 47763 | средняя | 478 | 4471 |
| Расчёт стоимости поездки | 397 | средняя | 4 | 40 |
| Управление поездками | 1100 | средняя | 11 | 110 |
| Чаты | 44 | лёгкая | 1 | 1 |
| Рейтинг | 320 | средняя | 4 | 32 |
| Оплата | 177 | средняя | 2 | 18 |
| История поездок | 4 | лёгкая | 1 | 1 |
| API-gateway | 41778 | лёгкая | 42 | 418 |
| nginx | 42525 | TLS-handshake | 24 * 5 | 80 |

В итоге на **один ДЦ** получим: 
 - 139 ядер CPU
 - 1074 ГБ RAM

Рассчитаем аналогично для баз данных. Положим, что на YDB на 1 CPU будет 500 IOPS.
...
Конфигурация подобрана согласно [22]

| Сервис | Конфигурация | CPU, ядер | RAM, ГБ | На 1 ДЦ | Цена, $ |
| - | - | - | - | - | - |
Kuber node | 2x6554S/2x16Gb/1xNVMe512Gb/2x25Gb/s | 72 | 128 | 15 серверов | 11260 |
YDB | 2x Xeon Gen3/4x64Gb/1xNVMe512Gb/2x25Gb/s  | 20 | 214 | 1 сервер | 1985 |
Redis | 2x Xeon Gen3/4x32Gb/1xNVMe512Gb/2x25Gb/s| 2 | 102 | 1 сервер | 1875 |
nginx | 2x6554S/2x16Gb/1xNVMe512Gb/2x25Gb/s | 120 | 80 | 1 сервер | 937 |
