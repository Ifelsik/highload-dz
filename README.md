...
4. Каждый сервис пишет логи и статистику в Prometheus, а также визуализируем в Grafana
5. Кэшируем данные о геокодировани и постройке маршрутов в микровервисах
